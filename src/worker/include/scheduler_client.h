...
public:
    ...
    bool RegisterWorker(const std::string& worker_id, const std::string& ip_address);

    // 2. 发送心跳
    bool SendHeartbeat(const std::string& worker_id, int running_task_count, float cpu_usage);
