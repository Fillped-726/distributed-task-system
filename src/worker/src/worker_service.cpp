...
grpc::Status WorkerServiceImpl::RunTask(grpc::ServerContext* context, 
    ...
    LOG_INFO << "Received RunTask Request: task_id=" << pb_task.task_id() << " name=" << pb_task.natural_id();
    ...
    response->mutable_header()->set_request_id(pb_task.task_id()); // 回填 ID 方便追踪
